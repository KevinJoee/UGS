...
class GaussianModel:
    def __init__(self, sh_degree: int, fea_dim=0, with_motion_mask=True):
    ...
    def param_names(self):
        return ['_xyz', '_features_dc', '_features_rest', '_scaling', '_rotation', '_rotation', '_opacity', 'max_radii2D', 'xyz_gradient_accum']
    ...
    def get_covariance(self, scaling_modifier=1, d_rotation=None):
